...
export default function Home() {
  ...
  const milestones: Milestone[] = [
    { id: 1, date: "September 12, 2016", title: "First Meeting", desc: "A chance encounter in a beautiful rooftop café in Addis Ababa. Sintayehu accidentally sat at Selamawit's table, and a 3-hour conversation bloomed into something eternal.", visualSeed: 45 },
